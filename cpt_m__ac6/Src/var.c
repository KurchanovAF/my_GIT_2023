...
int value_VT1 =  41800;//38930; //40500;//36500;//47500 для цезия//46930;
...
float value_VY_rez = 0;
int value_U2R = 32768;
int value_VT1 = 42500;//38000;//38000 для рубидия; 47500 для цезия// 46930; Курчанов
int value_L1 = 65000;
int value_T5 = 0;
int value_DTX = 30000;
int value_DTX_aver = 0;
...
// Флаг подключения цифрового датчика температуры
...
// Необходимая температура ячейки
...
// __attribute__((aligned(8))); 8 - байт выравнивание
//
...
int32_t  my_F2F1_sum_2[6];
int32_t  my_F2F1_P_sum[6];
int32_t  my_F1F2_sum[5];
int32_t  my_F1F2_sum_2[5];
